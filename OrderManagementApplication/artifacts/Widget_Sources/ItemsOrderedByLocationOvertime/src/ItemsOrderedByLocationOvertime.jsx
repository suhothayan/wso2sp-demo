...
class ItemsOrderedByLocationOvertime extends Widget {
    constructor(props) {
        super(props);
        this.stackedBarChartConfig = {
            x: 'AGG_TIMESTAMP',
            charts: [{type: 'area', y: 'itemsOrdered', fill: '#4659f9', color: 'location'}],
            maxLength: 6,
        ...
        this.metadata = {
            names: ['AGG_TIMESTAMP', 'location', 'itemsOrdered'],
    ...
    handleGraphUpdate() {
        ...
        super.getWidgetConfiguration(this.props.widgetID)
            .then((message) => {
                const dataProviderConf = ItemsOrderedByLocationOvertime.getProviderConf(message.data);
...
global.dashboard.registerWidget("ItemsOrderedByLocationOvertime", ItemsOrderedByLocationOvertime);
