...
class OrdersOvertime extends Widget {
    constructor(props) {
        super(props);
        this.stackedBarChartConfig = {
            x: 'AGG_TIMESTAMP',
            charts: [{type: 'line', y: 'orders', fill: '#4659f9'}],
            maxLength: 6,
    ...
    handleGraphUpdate() {
        ...
        super.getWidgetConfiguration(this.props.widgetID)
            .then((message) => {
                const dataProviderConf = OrdersOvertime.getProviderConf(message.data);
...
global.dashboard.registerWidget("OrdersOvertime", OrdersOvertime);
